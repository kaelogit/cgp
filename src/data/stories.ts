...
export const recipientStories: RecipientStory[] = [
  ...
  },
  {
    ...
    story: [
      ...
      'CAP treated the application like a real file, not a slogan. I wrote what the money would buy: a used van, insurance, and inventory to start. No one asked me to borrow against my house.',
      'The $220,000 grant let me open Hale Field Supply. I still work long days. The difference is the name on the door is mine, and the people I hired are on a payroll I can actually meet. CAP did not make me a salesman. I already was one. They gave me the start so I could work for myself.',
    ],
  },
  {
    name: 'Marisol V.',
    ...
    story: [
      ...
      'I applied under buying a home and told the truth: we were not asking CAP to buy us a mansion. We needed the last piece so the contract would hold.',
      'The $340,000 grant covered what the lender would not. We closed in April. The first night I sat on the floor of an empty living room and laughed until I cried. The house is modest. It is ours. Buying a home should not require a miracle. For us, a CAP grant was the last honest piece.',
    ],
  },
  {
    name: 'Keisha Grant',
    ...
    story: [
      ...
      'CAP’s teacher grant did not feel like charity. It felt like someone understood that educators are people with rent, too. I listed the bills and the classroom list separately so they could see both.',
      'Seventy-five thousand dollars restocked my room and caught up two months I had fallen behind. I still buy stickers. I do not skip my own grocery run to do it.',
    ],
  },
  {
    name: 'Arthur N.',
  ...
  },
  {
    ...
    story: [
      ...
      'Going to school is one of the reasons CAP says people should apply. I wrote that sentence on a notepad before I submitted, just to remind myself it was allowed.',
      'The $142,000 grant covered the remaining year. I finished. I work days now. When a patient asks how I got here, I tell them someone believed school was worth a grant, not another loan.',
    ],
  },
  {
    name: 'Calvin Reed',
    ...
    story: [
      ...
      'CAP asked for the statements, not a performance. I sent them. I waited. I did not sleep much that week.',
      'Two hundred sixty-five thousand dollars in grant money closed the file with the hospital. I still have follow-up appointments. I do not have a collector’s number saved in my phone.',
    ],
  },
  {
    name: 'Elena Briggs',
    ...
    story: [
      ...
      'The Center for American Opportunity application took an evening. I said I was looking for financial assistance and I meant it. No drama. Just numbers.',
      'The $98,000 grant put the utilities and the overdue dental work behind me. My son still visits. He brings pie, not cash. That is how it should be.',
    ],
  },
  {
    name: 'Jonah M.',
  ...
  },
  {
    ...
    story: [
      ...
      'Salespeople starting their own business is exactly the kind of file CAP said they review. I listed equipment, a first lease deposit, and three months of stock. I said plainly: this is not a loan I can service. I needed a grant.',
      'The $155,000 award let me open Cole Home Goods. I still sell. I just keep the margin. I hired two people from my old territory. That is the part I am proudest of.',
    ],
  },
  {
    name: 'Harold W.',
    ...
    story: [
      ...
      'Retired teachers may apply — CAP says that in plain language. I used it. I listed the roof, the medical share, and the fact that I still tutor two evenings a week because I like teenagers more than I like silence.',
      'The $95,000 grant repaired the house and covered the devices. I still tutor. I do it because I want to, not because the ceiling is leaking. Thank you is a small word for a large relief.',
    ],
  },
  {
    name: 'Aisha Bello',
    ...
    story: [
      ...
      'The $112,000 grant covered the remaining terms. I attend during the day. My son sees me in scrubs and thinks that is what grown-ups wear to become useful. I like that story better than the one where I quit.',
    ],
  },
  {
    name: 'Linda K.',
  ...
  },
  {
    ...
    story: [
      ...
      'The $82,000 grant restocked the lab and caught the car up. I still stay late. I do not skip dinner to buy pipettes. If you are a teacher reading this with a receipt in your wallet that should have been a school’s problem, apply.',
    ],
  },
  {
    name: 'Grace Okonkwo',
    ...
    story: [
      ...
      'Center for American Opportunity said completeness matters more than a perfect label. I was complete. I was not elegant. My coordinator treated the letter like a file, not a complaint.',
  ...
  },
  {
    ...
    story: [
      ...
      'CAP said salespeople starting their own business can apply. I wrote that sentence twice so I would not talk myself out of it. I listed a deposit, a lift, insurance, and enough inventory to last the first slow month. I said I did not want a loan. I wanted a grant so the first bad week would not own me.',
      'The $195,000 grant opened Delaney Motors. I still sell. I still work Saturdays. The difference is the sign. When a customer asks who the boss is, I do not point at a regional manager. I point at my own chest and then I get back to work. Thank you is not enough. It is what I have.',
    ],
  },
  {
    name: 'Betty R.',
    ...
    story: [
      ...
      'I applied because Center for American Opportunity said older retired people looking for financial assistance are welcome. I did not write a speech. I wrote the deductible, the copays, and the fact that my daughter lives four states away and I will not move in with her.',
      'The $105,000 grant closed those two files. I still live in my house. I still make soup on Sundays. If you are a senior reading this and you think asking is shameful, I asked. They answered. You can too.',
    ],
  },
  {
    name: 'Samuel Okoye',
  ...
  },
  {
    ...
    category: 'Retired teachers',
    amount: '$88,000',
    quote: 'I taught three generations in one town. The town did not owe me a roof. CAP helped anyway.',
    story: [
      ...
      'The $88,000 grant repaired the roof. I still volunteer. I do it dry. That is a small miracle and I will say thank you every time someone asks how the house looks.',
    ],
  },
  {
    name: 'Victoria Chen',
  ...
  },
  {
    ...
    story: [
      ...
      'I almost did not apply because I assumed CAP was only for people in trouble. The eligibility page says there is no income cap. I read it twice. We applied under buying a home and described the second property plainly — not a rescue, a goal we had been saving toward for a decade.',
      'The $575,000 grant closed the gap without turning our retirement into a mortgage story. We spend summers there now. Our daughter brings the kids in July. If you have means and a clear purpose, you are still allowed to ask. That was the part I needed to hear.',
    ],
  },
  {
...
export const recentAwards = [
  { name: 'Ruth P.', location: 'Ohio', category: 'Seniors', amount: '$165,000' },
  { name: 'Dominic H.', location: 'Georgia', category: 'Business', amount: '$220,000' },
  { name: 'Marisol V.', location: 'Nevada', category: 'Housing', amount: '$340,000' },
  { name: 'Keisha G.', location: 'Maryland', category: 'Teachers', amount: '$75,000' },
  { name: 'Arthur N.', location: 'Oregon', category: 'Retired teachers', amount: '$125,000' },
  { name: 'Priya S.', location: 'Illinois', category: 'Education', amount: '$142,000' },
  { name: 'Calvin R.', location: 'Tennessee', category: 'Medical', amount: '$265,000' },
  { name: 'Elena B.', location: 'Arizona', category: 'Seniors', amount: '$98,000' },
  { name: 'Jonah M.', location: 'Pennsylvania', category: 'Medical', amount: '$180,000' },
  { name: 'Nadia C.', location: 'Michigan', category: 'Business', amount: '$155,000' },
  { name: 'Harold W.', location: 'North Carolina', category: 'Retired teachers', amount: '$95,000' },
  { name: 'Aisha B.', location: 'Texas', category: 'Education', amount: '$112,000' },
  { name: 'Linda K.', location: 'Wisconsin', category: 'Housing', amount: '$285,000' },
  { name: 'Omar T.', location: 'New Jersey', category: 'Teachers', amount: '$82,000' },
  { name: 'Grace O.', location: 'Minnesota', category: 'Assistance', amount: '$135,000' },
  { name: 'Frank D.', location: 'Missouri', category: 'Business', amount: '$195,000' },
  { name: 'Betty R.', location: 'Florida', category: 'Seniors', amount: '$105,000' },
  { name: 'Samuel O.', location: 'Massachusetts', category: 'Medical', amount: '$310,000' },
  { name: 'Patricia M.', location: 'Iowa', category: 'Retired teachers', amount: '$88,000' },
  { name: 'Victoria C.', location: 'Connecticut', category: 'Business', amount: '$420,000' },
  { name: 'Richard A.', location: 'Colorado', category: 'Housing', amount: '$575,000' },
  { name: 'Marcus W.', location: 'New York', category: 'Education', amount: '$325,000' },
  { name: 'Lauren F.', location: 'California', category: 'Business', amount: '$485,000' },
  { name: 'James H.', location: 'Virginia', category: 'Housing', amount: '$435,000' },
  { name: 'Amara O.', location: 'Washington', category: 'Medical', amount: '$375,000' },
];
