...
export const APPLY_FAQS = [
  {
    q: 'Is a CAP grant a loan?',
    a: 'No. CAP programs are not loans. If you are selected, you do not repay the award. Applying does not create debt.',
  },
  {
    q: 'How soon will I hear back?',
    a: `${APPLY_FROM_NAME} sends a receipt from ${APPLY_FROM_EMAIL}. A CAP grants coordinator is then assigned to your file and contacts you within ${RESPONSE_HOURS} hours. Check inbox and spam, then reply on that thread.`,
  },
  {
