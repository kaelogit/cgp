...
export const metadata = createMetadata({
  title: 'CAP Terms — Grants Are Not Loans',
  description:
    'Terms for the official CAP Grants website. Applying does not create debt. Awards are grants, not loans, and are not guaranteed.',
  path: '/terms',
});
...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of use">
      <p className="mb-8 text-sm leading-relaxed text-[var(--cap-muted)]">{ORG_BLURB}</p>
      <LegalSection title="This website">
        {SITE_DOMAIN} is the official application site for {FULL_NAME}. Use it to learn about CAP
        grants, apply, and verify contact.
      </LegalSection>
      <LegalSection title="Grants are not loans">
        CAP Grants are not loans. Submitting an application does not create debt, an award,
        or a contract. If you are selected, you do not repay the grant. If you are not selected,
        applying still does not create an obligation to CAP.
      </LegalSection>
      <LegalSection title="Eligibility">
        ...
        every day and billions of dollars in CAP grant money go out each year.
      </LegalSection>
      <LegalSection title="Official contact">
        Follow-up is by email. Application receipts come from {APPLY_FROM_NAME} ({APPLY_FROM_EMAIL}).
        If you are unsure whether a message is from CAP, use the Verify page or write {CONTACT_EMAIL}{' '}
        before you act.
      </LegalSection>
