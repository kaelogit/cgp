...
export function CoordinatorSection() {
  return (
    <section className="border-y border-[var(--cap-line)] bg-[var(--cap-paper)] py-20">
      <div className="container-page max-w-3xl">
        ...
        <p className="mt-5 text-sm leading-relaxed text-[var(--cap-muted)]">
          Once your application is submitted, CAP assigns a coordinator to your file and contacts you
        ...
        <div className="mt-6 flex items-start gap-3 border border-[var(--cap-line)] bg-white p-4">
          <Clock className="mt-0.5 h-5 w-5 shrink-0 text-[var(--cap-accent)]" />
          <p className="text-sm text-[var(--cap-muted)]">
            Check your inbox and spam folder after you apply. Reply on the same email thread so your
            file stays together.
          </p>
        </div>
        <p className="mt-4 flex items-start gap-2 text-sm leading-relaxed text-[var(--cap-muted)]">
          <Shield className="mt-0.5 h-4 w-4 shrink-0 text-[var(--cap-accent)]" />
          If someone contacts you about a CAP grant before you have applied, use the Verify page
          first.
        </p>
